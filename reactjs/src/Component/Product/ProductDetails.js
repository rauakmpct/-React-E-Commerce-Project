        ...
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 h-auto mb-30">
            <div className="h-100 bg-light p-30">
              ...
              <h3 className="font-weight-semi-bold mb-4">dhjj</h3>
          ...
          <div className="col">
            <div className="bg-light p-30">
              <div className="nav nav-tabs mb-4">
                <Link className="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Description</Link>
                <Link className="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-2">Information</Link>
                <Link className="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">Reviews (0)</Link>
              </div>
